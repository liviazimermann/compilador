...
void janela::on_Compilar_clicked()
{
    ...
    // Limpa a tabela e saídas antes de compilar
    ui->tabelaSimbolos->setRowCount(0);
    ui->outputErro->setPlainText("");
    ui->outputAsm->setPlainText("");
    ...
    try {
        ...
        // Exibir código assembly BIP gerado
        QString codigoAsm = QString::fromStdString(Sem.getCodigoGerado());
        ui->outputAsm->setPlainText(codigoAsm);
    }
